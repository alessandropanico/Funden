        ...
        .bind('click', function (event) {
          ...
          $('html, body')
            ...
            .animate(
              {
                scrollTop:
                  $('#' + target.attr('title')).offset().top - headerH + 'px',
              },
              100,
              'easeInOutExpo'
            );
  ...
  function callAll() {
    ...
    if ($('.scroll-to-target').length) {
      $('.scroll-to-target').on('click', function (e) {
        ...
        if (target) {
          ...
          $('html, body').animate(
            {
              scrollTop: $(target).offset().top ? $(target).offset().top : 0,
            },
            0
          );
        } else {
    ...
    if ($('.testimonials-slider').length) {
      $('.testimonials-slider').bxSlider({
        ...
        pager: true,
        pagerCustom:
          '.testimonials-slider-pager-one, .testimonials-slider-pager-two',
      });
    }
